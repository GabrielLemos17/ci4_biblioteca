<div class="container p-5 text-light">
    ...
    <input value='<?=$emprestimo['id_livro']?>' type="hidden" name='id_livro_antigo'>
    <div class="row p-2">
        <div class="col-2">
    ...
    <div class="row p-4">
        <div class="col">
            <div class="btn-group w-100" role="group">
                <a href='http://localhost:8080/index.php/Emprestimo/index'class="btn btn-outline-dark">Cancelar</a>
